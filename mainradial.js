...
setInterval(() => {
    document.getElementById("change").style.backgroundImage = "radial-gradient( " + document.querySelector(".color1").value + ", " + document.querySelector(".color2").value + ")";

    document.getElementById("text").innerHTML = "background-image: radial-gradient(" + document.querySelector(".color1").value + ", " + document.querySelector(".color2").value + ");"
